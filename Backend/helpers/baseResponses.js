const baseResponses = {
    ...
    constantMessages: {
        ...
        PASSWORD_INVALID:(data = null) => baseResponses.error("Password must be at least 6 characters long, include at least one uppercase letter, one lowercase letter, one number, and one special character.",data),
