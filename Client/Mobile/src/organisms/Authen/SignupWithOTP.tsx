...
const SignupWithOTP = ({ navigation }) => {
    ...
    const handleSubmitPress = () => {
        ...
        navigation.navigate('VerificationCode', { phoneNumber: phoneNumberValue });
    };
        ...
        <View style={[styles.containerStyle, { padding: 0, gap: 0 }]}>
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center' }}>
                <View style={[styles.containerStyle]}>
                    ...
                    <Text style={styles.signupsubtitle}>We will send you the 6 digit verification code</Text>
